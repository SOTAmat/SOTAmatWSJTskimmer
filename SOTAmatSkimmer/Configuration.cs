...
namespace SOTAmatSkimmer
{
    public class Configuration
    {
        ...
        [Option('c', "callsign", Required = false, HelpText = "Your callsign (and www.SOTAmat.com username).  Required.")]
        ...
        [Option('g', "gridsquare", Required = false, HelpText = "The 6-character Gridsquare of your antenna location. Required.")]
        ...
        [Option('p', "password", Required = false, HelpText = "Your password on www.SOTAmat.com")]
